...
public class Resources {
    // Main Frame
    public static final String APP_FRAME_TITLE = "2048";

    // End Dialog
    public static final String END_DIALOG_TITLE_END_GAME = "Game ended";
    ...
    public static final String MAIN_FRAME_MENU_DISPLAY_LABEL = "Display";
    public static final String MAIN_FRAME_MENU_ITEM_TOGGLE_LEADERBOARD = "Display leaderboard";
    public static final String MAIN_FRAME_MENU_ITEM_QUIT_LABEL = "Quitter";
